...
import { listProjects, listTools } from "./data";
  ...
  return (
    <>
      <div className="absolute top-0 left-0 w-full h-full -z-10 ">
        <Aurora
          colorStops={["#a5bdb7", "#5b1c85", "#1bb39e"]}
          blend={0.5}
          amplitude={1.0}
          speed={0.5}
        />
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="hero grid md:grid-cols-2 items-center pt-10 xl:gap-0 gap-6 grid-cols-1">
          <div className="animate__animated animate__fadeInUp animate__delay-3s">
            ...
            <h1 className="text-5xl font-bold mb-6">
              <ShinyText text={t.greeting} disabled={false} speed={3} className='custom-class' />
            </h1>
            <BlurText
              text={t.description}
              delay={150}
            ...
            <div className="flex items-center sm:gap-4 gap-2">
              ...
              >
                <ShinyText text={t.downloadCV} disabled={false} speed={3} className="custom-class" />
              </a>

              <a href="#project" className="font-semibold bg-[#1a1a1a] p-4 px-6 rounded-full border border-gray-700 hover:bg-[#222] transition-colors">
                <ShinyText text={t.exploreProjects} disabled={false} speed={3} className="custom-class" />
              </a>
            </div>
              ...
              <div className="flex-1 text-left">
                ...
                <div className="flex flex-col sm:flex-row items-center sm:justify-between text-center sm:text-left gap-y-8 sm:gap-y-0 mb-4 w-full">
                  ...
                  <div>
                    ...
                    <p>{t.systemsIntegrated}</p>
                  </div>
                  <div data-aos="fade-up" data-aos-duration="1000" data-aos-delay="600" data-aos-once="true">
                    <h1 className="text-3xl md:text-4xl mb-1">
                      3x<span className="text-violet-500"></span>
                    </h1>
                    <p>{t.performanceBoost}</p>
                  </div>
                </div>
        ...
        <div className="tools mt-32">
          <h1 className="text-4xl/snug font-bold mb-4" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true" >{t.toolsTechnologies}</h1>
          <p className="w-2/5 text-base/loose opacity-50" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300" data-aos-once="true">{t.professionalSkills}</p>
